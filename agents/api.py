"""
FastAPI REST API Server for Fasta Gc Calculator.
"""
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "fasta-gc-calculator", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
